...
async function run(): Promise<void> {
  ...
  assert.deepEqual(Object.keys(exposedApi!).sort(), [
    ...
    'getWindowState', 'onMenuAction', 'onUpdateStatus', 'onWindowStateChanged', 'openKdsWindow', 'openSmsShare', 'openWhatsAppShare', 'platform', 'reportRendererError', 'restartAndInstall',
  ...
  await call('openSmsShare', 'sms:+15555550100?body=test');
  ...
  assert.deepEqual(calls, [
    ...
    { channel: 'sms-open-share', args: ['sms:+15555550100?body=test'] },
