...
| [fashion-retail-platform.md](fashion-retail-platform.md) | Approved India fashion-retail platform architecture: central PostgreSQL service, offline POS event/outbox synchronization, size/colour variants, GST, Razorpay, and VPS deployment. | ACTIVE DESIGN |
