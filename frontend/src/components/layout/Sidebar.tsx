...
export default function AppSidebar() {
  ...
  const { tablesRequired, kdsEnabled, setTablesRequired, setKdsEnabled, setWhatsappEnabled } = usePosSettingsStore();
  ...
  const navItems = ALL_NAV_ITEMS.filter((item) => {
    ...
    // Keep the connection entry visible so an owner can enable WhatsApp for a new store.
