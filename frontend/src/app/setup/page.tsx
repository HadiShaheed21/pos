...
import { ArrowLeft, ArrowRight, Check, Cloud, Database, KeyRound, Search, Sparkles, Shirt, Eye, EyeOff } from 'lucide-react';
...
// Typed message keys for setup profile cards.
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted px-4 py-12">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          <div className="mx-auto mb-4 grid size-[72px] place-items-center rounded-2xl bg-[#10284b] font-serif text-2xl font-black tracking-tight text-white shadow-lg">US</div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4">
                  {SETUP_PROFILES.map((item) => {
                    ...
                    const Icon = item.value === 'demo' ? Database : item.value === 'express' ? Sparkles : Shirt;
                    return (
                      <button
                        key={item.value}
