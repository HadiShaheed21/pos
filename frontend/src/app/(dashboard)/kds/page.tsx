...
export default function KdsPage() {
  ...
  const businessType = useAuthStore((state) => state.currentTenant?.business_type);
  ...
  useEffect(() => {
    if (businessType === 'fashion_retail') router.replace('/online-store');
  }, [businessType, router]);

  if (businessType === 'fashion_retail') return null;
